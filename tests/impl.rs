...
fn test_call_no_args_primitive_return() {
    ...
    test_struct.__interactive_eval_method("get_field", "", &mut |result| {
...
fn test_call_no_args_no_return() {
    ...
    test_struct.__interactive_eval_method("answer", "", &mut |result| {
...
fn test_method_not_found() {
    ...
    test_struct.__interactive_eval_method("yeet", "", &mut |result| {
        assert_eq!(
            result.unwrap_err(),
...
fn test_clone_method() {
    ...
    test_struct.__interactive_eval_method("clone", "", &mut |result| {
...
fn test_private_method() {
    ...
    test_struct.__interactive_eval_method("_private_method", "", &mut |result| {
        assert_eq!(
            result.unwrap_err(),
            InteractiveError::MethodNotFound {
                type_name: "TestStruct",
...
fn test_associated_function() {
    ...
    test_struct.__interactive_eval_method("_new", "", &mut |result| {
        assert_eq!(
            result.unwrap_err(),
            InteractiveError::MethodNotFound {
                type_name: "TestStruct",
...
fn test_too_many_args() {
    ...
    test_struct.__interactive_eval_method("answer", "43", &mut |result| {
        assert_eq!(
            result.unwrap_err(),
